...
try:
    from models.vim.mamba_ssm.ops.triton.layernorm import RMSNorm, layer_norm_fn, rms_norm_fn
except ImportError:
...
class VisionMamba(nn.Module):
    def __init__(self, 
        ...
        if if_abs_pos_embed:
            self.pos_embed = nn.Parameter(torch.zeros(1, channels+1, self.embed_dim)) #num_patches + self.num_tokens
