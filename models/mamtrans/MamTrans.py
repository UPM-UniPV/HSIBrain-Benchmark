...
class MamTrans(nn.Module):
    ...
    def __init__(self, channels, num_classes, image_size, datasetname, patch_size: int = 1, emb_dim: int = 256,
        ...
        self.patch_embeddings = PatchEmbeddings(
            patch_size=patch_size, patch_dim=patch_dim, emb_dim=emb_dim)
        self.pos_embeddings = PositionalEmbeddings(
            num_pos=self.num_patches, dim=emb_dim)
        ...
        self.mamba_back = nn.ModuleList(
            Mamba(emb_dim) for i in range(num_layers))
