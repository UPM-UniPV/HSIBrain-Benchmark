...
class RotaryEmbedding(Module):
    ...
    def __init__(
        ...
        if exists(custom_freqs):
            ...
            freqs = 1. / (theta ** (torch.arange(0, dim, 2)
                          [:(dim // 2)].float() / dim))
    ...
    def rotate_queries_or_keys(
            self, t, seq_dim=None, offset=0, freq_seq_len=None):
    ...
    def rotate_queries_with_cached_keys(self, q, k, seq_dim=None, offset=0):
        ...
        rotated_q = self.rotate_queries_or_keys(
            q, seq_dim=seq_dim, freq_seq_len=k_len)
    ...
    def rotate_queries_and_keys(self, q, k, seq_dim=None):
        ...
        rotated_k = apply_rotary_emb(
            freqs, k, scale=scale ** -1, seq_dim=seq_dim)
